...
boilerplate.DynamicContentElements = function () {
    ...
    devDynamicContent.TAFEDynamicBanners_728x90[0].location = "Cessnock,New South Wales,Australia";
    devDynamicContent.TAFEDynamicBanners_728x90[0].ad_name = "course-riv-1";
    devDynamicContent.TAFEDynamicBanners_728x90[0].campus_location = "Riverina Institute";
    ...
    devDynamicContent.TAFEDynamicBanners_728x90[0].frame3Text = "at the <span>Riverina Institute<\/span>.";
    ...
    devDynamicContent.TAFEDynamicBanners_728x90[0].rtoCode = "RTO 91430";
