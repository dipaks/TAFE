...
boilerplate.DynamicContentElements = function () {
    ...
    devDynamicContent.TAFEDynamicBanners_728x90[0].ad_name = "ad1";
    devDynamicContent.TAFEDynamicBanners_728x90[0].location = "Brookvale,New South Wales,Australia";
    ...
    devDynamicContent.TAFEDynamicBanners_728x90[0].frame3Text = "at the <span>Brookvale<\/span> campus.";
    devDynamicContent.TAFEDynamicBanners_728x90[0].frame4Text = "Enrolments are now open!";
    devDynamicContent.TAFEDynamicBanners_728x90[0].fontSize_Text = 18;
