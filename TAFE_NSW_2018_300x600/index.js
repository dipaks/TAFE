...
boilerplate.DynamicContentElements = function () {
    ...
    devDynamicContent.TAFEDynamicBanners_300x600[0].ad_name = "ad1";
    devDynamicContent.TAFEDynamicBanners_300x600[0].location = "Brookvale,New South Wales,Australia";
    ...
    devDynamicContent.TAFEDynamicBanners_300x600[0].frame3Text = "at the <span>Brookvale<\/span> campus.";
	...
	bub1.style.cssText = bub2.style.cssText = bub3.style.cssText = "background-color:" + dynamicContent.TAFEDynamicBanners_300x600[0].bub_backgroundColor + ";";
