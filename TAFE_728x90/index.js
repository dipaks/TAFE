...
boilerplate.DynamicContentElements = function () {
    ...
    devDynamicContent.TAFEDynamicBanners_728x90[0].ad_type = "";
    devDynamicContent.TAFEDynamicBanners_728x90[0].ad_name = "Generic";
    devDynamicContent.TAFEDynamicBanners_728x90[0].location = "Sydney,New South Wales,Australia";
    devDynamicContent.TAFEDynamicBanners_728x90[0].course_name = "BUSINESS & FINANCE";
    devDynamicContent.TAFEDynamicBanners_728x90[0].logo = {};
    devDynamicContent.TAFEDynamicBanners_728x90[0].logo.Type = "file";
    devDynamicContent.TAFEDynamicBanners_728x90[0].logo.Url = "https://s0.2mdn.net/ads/richmedia/studio/60006638/60006638_20180619215452769_waratahlogo.png";
    ...
    devDynamicContent.TAFEDynamicBanners_728x90[0].hero_image.Url = "https://s0.2mdn.net/ads/richmedia/studio/60006638/60006638_20180619215436578_mustardshorts.png";
    ...
    devDynamicContent.TAFEDynamicBanners_728x90[0].fontSize_HeadlineText = "20px";
    devDynamicContent.TAFEDynamicBanners_728x90[0].frame1ButtonText = "BE AMBITIOUS";
    devDynamicContent.TAFEDynamicBanners_728x90[0].frame1HeadlineText = "BE EMPLOYED";
    devDynamicContent.TAFEDynamicBanners_728x90[0].frame1SubText = "With connections to over 25,000 employers.";
    devDynamicContent.TAFEDynamicBanners_728x90[0].frame2Text = "Mid-year enrolments<br>are now open at";
    devDynamicContent.TAFEDynamicBanners_728x90[0].TAFE_Location = "<br>Sydney TAFE.";
    devDynamicContent.TAFEDynamicBanners_728x90[0].fontSize_Text = "18px";
    devDynamicContent.TAFEDynamicBanners_728x90[0].rtoCode = 91430;
    devDynamicContent.TAFEDynamicBanners_728x90[0].buttonText = "ENROL TODAY";
    ...
    devDynamicContent.TAFEDynamicBanners_728x90[0].exitUrl.Url = "https://www.tafensw.edu.au/courses/hospitality-courses";
    devDynamicContent.TAFEDynamicBanners_728x90[0].isDefault = true;
	...
	banner.style.cssText = "background-color:" + devDynamicContent.TAFEDynamicBanners_728x90[0].backgroundColor + ";";
	bub1.style.cssText = bub2.style.cssText = "background-color:" + devDynamicContent.TAFEDynamicBanners_728x90[0].bub_backgroundColor + ";";
	logo.src = devDynamicContent.TAFEDynamicBanners_728x90[0].logo.Url;
	be_image.src = devDynamicContent.TAFEDynamicBanners_728x90[0].be_image1.Url;
	hero_image.src = devDynamicContent.TAFEDynamicBanners_728x90[0].hero_image.Url;
	frame1_ctaText.innerHTML = devDynamicContent.TAFEDynamicBanners_728x90[0].frame1ButtonText;
	headline_text.innerHTML = devDynamicContent.TAFEDynamicBanners_728x90[0].frame1HeadlineText;
	headline_text.style.cssText = "font-size:" + devDynamicContent.TAFEDynamicBanners_728x90[0].fontSize_HeadlineText + "; color:" + devDynamicContent.TAFEDynamicBanners_728x90[0].textColour + ";";
	text2.innerHTML = devDynamicContent.TAFEDynamicBanners_728x90[0].frame1SubText;
	text3.innerHTML = devDynamicContent.TAFEDynamicBanners_728x90[0].frame2Text + " " + devDynamicContent.TAFEDynamicBanners_728x90[0].TAFE_Location;
	text2.style.cssText = text3.style.cssText = "font-size:" + devDynamicContent.TAFEDynamicBanners_728x90[0].fontSize_Text + "; color:" + devDynamicContent.TAFEDynamicBanners_728x90[0].textColour + ";";
	rto_code.innerHTML = devDynamicContent.TAFEDynamicBanners_728x90[0].rtoCode;
	cta_text.innerHTML = devDynamicContent.TAFEDynamicBanners_728x90[0].buttonText;
	cta_text.style.cssText = "color:" + devDynamicContent.TAFEDynamicBanners_728x90[0].buttonTextColour + ";";
	cta.style.cssText = "; background-color:" + devDynamicContent.TAFEDynamicBanners_728x90[0].buttonColour + ";";
	exitUrl = devDynamicContent.TAFEDynamicBanners_728x90[0].exitUrl.Url;
...
boilerplate.executeAnimation = function (){
	...
	.to('#rto-code',.50,{opacity:1, onComplete:completeHandler},'+=0.3')
