...
boilerplate.DynamicContentElements = function () {
	...
	Enabler.setProfileId(10059382);
    var devDynamicContent = {};

    devDynamicContent.TAFEDynamicBanners_160x600= [{}];
    devDynamicContent.TAFEDynamicBanners_160x600[0]._id = 0;
    devDynamicContent.TAFEDynamicBanners_160x600[0].unique_id = 1;
    devDynamicContent.TAFEDynamicBanners_160x600[0].location = "Singleton,Cessnock,Maitland,Muswellbrook,Newcastle,Central Coast,Raymond Terrace,Erina,Newcastle,New South Wales,Australia";
    devDynamicContent.TAFEDynamicBanners_160x600[0].audience_Id = 512656666;
    devDynamicContent.TAFEDynamicBanners_160x600[0].ad_name = "Animal,_Agriculture_&_Environment_Hunter_Institute_1";
    devDynamicContent.TAFEDynamicBanners_160x600[0].campus_location = "Hunter Institute";
    ...
    devDynamicContent.TAFEDynamicBanners_160x600[0].hero_image.Url = "https://s0.2mdn.net/ads/richmedia/studio/60006638/60006638_20180902190822590_animal_agriculture_environmental_studies_160x600.png";
    devDynamicContent.TAFEDynamicBanners_160x600[0].be_image1 = {};
    devDynamicContent.TAFEDynamicBanners_160x600[0].be_image1.Type = "file";
    devDynamicContent.TAFEDynamicBanners_160x600[0].be_image1.Url = "https://s0.2mdn.net/ads/richmedia/studio/60006638/60006638_20180619211011149_be_1.png";
    devDynamicContent.TAFEDynamicBanners_160x600[0].be_image2 = {};
    devDynamicContent.TAFEDynamicBanners_160x600[0].be_image2.Type = "file";
    devDynamicContent.TAFEDynamicBanners_160x600[0].be_image2.Url = "https://s0.2mdn.net/ads/richmedia/studio/60006638/60006638_20180619211025542_be_2.png";
    ...
    devDynamicContent.TAFEDynamicBanners_160x600[0].frame3Text = "at the <span>Hunter Institute<\/span>.";
    ...
    devDynamicContent.TAFEDynamicBanners_160x600[0].rtoCode = "RTO 90003";
    ...
    devDynamicContent.TAFEDynamicBanners_160x600[0].isActive = "YES";
	...
	bub1.style.cssText = bub2.style.cssText = bub3.style.cssText = bub4.style.cssText = "background-color:" + dynamicContent.TAFEDynamicBanners_160x600[0].bub_backgroundColor + ";";
