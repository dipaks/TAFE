...
// Dynamic Content variables and sample values
    ...
    devDynamicContent.TNS032_Digital_Dynamic01_Feed[0].Background_Image01.Url = "mustardshorts_300x600.png";
    ...
    devDynamicContent.TNS032_Digital_Dynamic01_Feed[0].Dynamic_Logo.Url = "waratahlogo_300x600.png";
...
creative.animation=function()
{
	...
	.to('#dytxt1',.50,{opacity:0, ease: Power2. easeOut},'-=0.5')
