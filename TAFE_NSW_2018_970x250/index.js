...
boilerplate.DynamicContentElements = function () {
    ...
    devDynamicContent.TAFEDynamicBanners_970x250[0].location = "Singleton,Cessnock,Maitland,Muswellbrook,Newcastle,Central Coast,Raymond Terrace,Erina,Newcastle,New South Wales,Australia";
    devDynamicContent.TAFEDynamicBanners_970x250[0].audience_Id = 512656666;
    devDynamicContent.TAFEDynamicBanners_970x250[0].ad_name = "Animal,_Agriculture_&_Environment_Hunter_Institute_1";
    devDynamicContent.TAFEDynamicBanners_970x250[0].campus_location = "Hunter Institute";
    ...
    devDynamicContent.TAFEDynamicBanners_970x250[0].frame2HeadlineText = "BE EMPLOYED.";
    devDynamicContent.TAFEDynamicBanners_970x250[0].frame2SubText = "Explore <span>Animal, Agriculture & Environment<\/span> courses";
    devDynamicContent.TAFEDynamicBanners_970x250[0].frame3Text = "at the <span>Hunter Institute<\/span>.";
